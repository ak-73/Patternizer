...
public interface BuilderInsertMethod extends PatternInsertMethod
{
	 ...
	 * @param insertionHelper
	 */
	void privatizeAndFinalizeFields(List<FieldDeclaration> fieldList, InsertionDataDefault insertionHelper);
	 ...
	 * @param configData
	 */
	void removeMethodsFromTopClass(List<FieldDeclaration> fieldList, InsertionDataDefault insertionHelper, BuilderConfigData configData);
	
	/**
	 * Add an empty, nested Builder class to the source of the class we're applying the pattern to.
	 * @param insertionHelper
	 */
	TypeDeclaration addBuilderClassToAST(InsertionDataDefault insertionHelper, BuilderConfigData configData);
	 ...
	 * @param insertionHelper
	 */
	void addFieldsToBuilderClass(TypeDeclaration builderClass, List<FieldDeclaration> fieldList, InsertionDataDefault insertionHelper, BuilderConfigData configData);
	 ...
	 * @param configData
	 */
	void addMethodsToBuilderClass(TypeDeclaration builderClass, List<FieldDeclaration> fieldList, InsertionDataDefault insertionHelper, BuilderConfigData configData);
	 ...
	 * @param configData
	 */
	void addBuilderConstructorToTopClass(TypeDeclaration builderClass, List<FieldDeclaration> fieldList, InsertionDataDefault insertionHelper, BuilderConfigData configData);	
